...
const TestomonialSection = () => {
  ...
  return (
    <section className="w-full relative">
      ...
      <div className="relative py-10 sm:py-14 px-4 sm:px-6">
          ...
          >
            <div className="flex flex-col lg:flex-row relative">
              <div className="lg:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center z-10 min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:min-h-[500px]">
                <p className="text-base sm:text-lg md:text-xl leading-relaxed max-w-sm sm:max-w-md text-white">
                  {testimonials[active].text}
                </p>
                <p className="mt-4 text-sm sm:text-base opacity-80 text-white">
